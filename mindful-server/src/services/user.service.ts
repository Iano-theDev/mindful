...
export class UserService {
    ...
    // create a new user
    createUser = async (data: { firstName: string; middleName: string; lastName: string; DOB: string; nationality: string; occupation: string; userName: string; email: string; role: any, password: string; phone: string; }): Promise<IUser> => {
