...
export class SignupComponent {
    ...
    //   firstName!: string;
      ...
      constructor(public layoutService: LayoutService, private authService: AuthService, private fb: FormBuilder, private messageService: MessageService) {
      ...
      onSubmit() {
          console.log("Email: ", this.signupForm)
